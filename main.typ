...
#grid(
  ...
  block(
    ...
    #text(size: 9.6pt, fill: dark)[
      ...
      Jeg foretrekker å jobbe med språk med gode typesystemer, høy ytelse og generelt gode garantier om hvordan koden vil oppføre seg. Som all-around språk bruker jeg mest Rust, som gir høyere ytelse enn GC-språk uten (alle) problemene C/C++ har med minnehåndtering. Jeg lærer meg for tiden Haskell, et av de eldre og mest robuste funksjonelle programmeringsspråkene. \ #v(1pt)
      Arkitekturmessig er jeg veldig fascinert av event sourcing og event modeling. Vi brukte nylig dette i et gruppeprosjekt hvor vi lagde en infoside med crowdsourcing til studenter ved OsloMet. \ #v(1pt)
      I tillegg til språkene jeg bruker til utvikling, bruker jeg Nix og NixOS til å konfigurere alle prosjektene og maskinene mine. Eksempelvis styrer Nix dedikerte utviklingsmiljøer per prosjekt. Disse kan deles mellom utviklere og krever verken virituelle maskiner eller Docker-containere. Jeg bruker også Nix til å synkronisere alle mine personlige maskiner, samt deploye til - og oppdatere - servere.
    ]
    ...
    #heading-main[Jobberfaring]
      ...
      details: "Følge til arbeid, fritidsaktiviteter og sosiale aktiviteter",
    )
    #entry(
      "Jul 2020 - Jul 2021",
      "Coop Obs Elverum",
